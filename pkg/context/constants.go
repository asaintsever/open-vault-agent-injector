...
const (
	//--- Open Vault Agent Injector annotation keys (without prefix)
	...
	// Output annotation (set by OVAI webhook)
...
const (
	//--- Open Vault Agent Injector status
	VaultInjectorStatusInjected = "injected"
)

const (
	VaultK8sAuthMethod     = "kubernetes" // Vault K8S auth method. Default for OVAI.
